  ...
  "settings": {
    ...
    "subscribe": {
      ...
      "unavailable_tip_enable": {
        ...
        "description": "Если включено, пользователи без доступной подписки получат строки-напоминания в подписке."
      },
      "unavailable_tip_lines": {
        "title": "Текст строк напоминания",
        "placeholder": "Трафик закончился или тариф истек. Пожалуйста, продлите подписку.",
        "description": "Каждая строка становится отдельным узлом-напоминанием в клиенте."
      },
      "saving": "Сохранение...",
      "plan": {
        "title": "Тарифные планы",
