    ...
    <div class="dashboard-main-grid">
      <section class="panel dashboard-chart-panel">
        ...
        <div v-else-if="orders.length" class="dashboard-chart">
          <svg viewBox="0 0 620 200" preserveAspectRatio="none" aria-label="收入趋势图"><defs><linearGradient id="dashboardArea" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#2563eb" stop-opacity=".32"/><stop offset="100%" stop-color="#2563eb" stop-opacity="0"/></linearGradient></defs><line v-for="y in [30,80,130,180]" :key="y" x1="0" :y1="y" x2="620" :y2="y" class="chart-grid-line"/><polygon :points="`0,180 ${chartPoints} 620,180`" fill="url(#dashboardArea)"/><polyline :points="chartPoints" class="chart-line"/></svg>
