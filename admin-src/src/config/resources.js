export const resources = {
  ...
  '/system/notice': { title: '公告管理', endpoint: '/notice/fetch', save: '/notice/save', drop: '/notice/drop', rowKeys: ['id', 'title', 'tags', 'show', 'popup'], editableKeys: ['id', 'title', 'content', 'img_url', 'tags', 'show', 'popup'] },
  ...
  '/subscription/plan': { title: '套餐管理', endpoint: '/plan/fetch', save: '/plan/save', drop: '/plan/drop', rowKeys: ['id', 'name', 'group_id', 'transfer_enable', 'show', 'renew'], editableKeys: ['id', 'name', 'content', 'group_id', 'transfer_enable', 'speed_limit', 'device_limit', 'capacity_limit', 'transfer_price', 'prices', 'tags'] },
  '/subscription/order': { title: '订单管理', endpoint: '/order/fetch', save: '/order/update', rowKeys: ['trade_no', 'user_id', 'plan_id', 'total_amount', 'status', 'created_at'], editableKeys: ['id', 'status', 'commission_status'], paginated: true },
  ...
  '/user/list': { title: '用户管理', endpoint: '/user/fetch', save: '/user/update', rowKeys: ['id', 'email', 'plan_id', 'balance', 'commission_balance', 'expired_at', 'banned'], editableKeys: ['id', 'email', { key: 'password', help: '留空则不修改密码' }, 'plan_id', 'transfer_enable', 'expired_at', 'balance', 'commission_balance', 'commission_rate', 'discount', 'speed_limit', 'device_limit', 'banned', 'is_staff', 'is_admin', 'remarks'], paginated: true, create: false },
