(function () {
  ...
  function ensureStyle() {
    ...
    style.textContent = [
      ...
      '[' + ENTRY_ATTR + '="menu"].xgb-active a{background:#eff6ff!important;color:#2563eb!important;font-weight:700!important}',
      '[' + ENTRY_ATTR + '="menu"].xgb-active svg{color:#2563eb!important}',
      ...
      '#xboard-group-buy-page .xgb-toolbar input:focus,#xboard-group-buy-page .xgb-toolbar select:focus,#xboard-group-buy-page .xgb-form input:focus,#xboard-group-buy-page .xgb-form select:focus{border-color:#3b82f6;box-shadow:0 0 0 3px rgba(37,99,235,.12)}',
      ...
      '#xboard-group-buy-page .xgb-link{border:0;background:transparent;color:#2563eb;font-size:13px;font-weight:800;cursor:pointer;padding:0}',
